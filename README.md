...
Процесс создания сервиса сокращения ссылок включает в себя несколько этапов: проектирования и заканчивая реализацией и
тестированием.
...
1. Проектирование
   ...
   Функциональные требования:
    ...
    5. Ссылки должны быть доступны для перехода, редактирования и удаления только тем пользователям, которыми они были
       созданы.
...
5. Документация по модулям
    1. Модуль console
       Описание: Модуль отвечает за взаимодействие с пользователем через консоль. Он предоставляет интерфейс для ввода
       команд и отображения результатов.
    ...
    2. Модуль db
       Описание: Модуль отвечает за взаимодействие с базой данных. Он содержит классы для работы с таблицами
       пользователей и ссылок.
    ...
    3. Модуль service
       Описание: Модуль содержит бизнес-логику приложения. Он управляет взаимодействием между репозиториями и консольным
       интерфейсом.
       Класс User Service:
       • Методы:
    ...
    5. Модуль config
       Описание: Модуль отвечает за конфигурацию приложения, включая параметры подключения к базе данных и другие
       настройки.
       Класс Config:
       • Методы:
